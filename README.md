...
- [Awesome GitHub Copilot Azure Logic Apps and Power Automate Instructions](https://github.com/github/awesome-copilot/blob/main/instructions/azure-logic-apps-power-automate.instructions.md) - AI agent instructions to guide them in writing high-quality Azure Logic Apps and Microsoft Power Automate workflow definitions.
...
- [Logic Apps Error Handling: Configure Run After Settings](https://turbo360.com/blog/logic-app-error-handling-configure-run-after-settings) - Explains how to use "Configure run after" to override default action execution behavior in Logic Apps, and how to implement try/catch/finally patterns using Scopes for centralized error handling across multiple actions.
